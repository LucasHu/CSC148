...
class Course:
    ...
    def is_takeable(self):
        ...
        if self.prereqs == []:
            ...
            return True  # taken courses are takeable
        else:
    ...
    def add_prereq(self, prereq):
        ...
        """
        if prereq.name in self:  # if prereq in self tree
            raise PrerequisiteError
        elif self.name in prereq:  # if self in prereq tree
            raise PrerequisiteError
        else:
    ...
    def missing_prereqs(self):
        ...
        for prereq in self.prereqs:
            if prereq.taken is False:  # if a course is not taken, trace down
    ...
    def __contains__(self, code):
        ...
        if self.name == code:
            ...
            for cour in self.prereqs:  # if the course is not root, trace down
                if code in cour:
                    return True
            return False
